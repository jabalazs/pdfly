...
parser = argparse.ArgumentParser(description='Performs basic operations on '
                                             'PDF files')
...
extract_subparser = subparsers.add_parser(
                               ...
                               description='Extract pages from a PDF '
                                           'file and save them to a new file')
extract_subparser.add_argument('infile',
                               type=str,
                               help='Input PDF to be processed')
extract_subparser.add_argument('outfile',
                               type=str,
                               help='Path of the output file')
extract_subparser.add_argument('from_page', type=int,
                               help="""First page to be extracted. Both 0 and 1
                                    mean the first page""")
extract_subparser.add_argument('to_page', type=int,
