...
def split(document, new_document, from_page=0, to_page=0):
    """
    ...
    """
    page_validation = pages_are_valid(from_page, to_page)
...
def pages_are_valid(from_page, to_page):
...
if __name__ == '__main__':
    # main()
    split("document1.pdf", "splitted.pdf", to_page=5)
